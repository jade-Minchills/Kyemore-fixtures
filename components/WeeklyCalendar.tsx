...
export function WeeklyCalendar({ weekDays, fixtures, onFixtureClick }: WeeklyCalendarProps) {
  ...
  const handleEventClick = (fixture: FixtureWithSport) => {
    // Open popup with all events for that day
    const fixtureDate = new Date(fixture.start_time);
    setSelectedDay(fixtureDate);
  };
  ...
  return (
    <>
                  ...
                  {dayFixtures.map((fixture) => {
                    ...
                    return (
                      <button
                        ...
                        onClick={() => handleEventClick(fixture)}
      ...
      {/* Reuse same popup component as Month view */}
      <DayEventsSheet
        date={selectedDay}
